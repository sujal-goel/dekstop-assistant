...
# path = "b6a3af97-82a3-4792-932b-4aa52145b832"
def AuthenticateFace(path,name):

    flag = ""
    # Local Binary Patterns Histograms
    recognizer = cv2.face.LBPHFaceRecognizer_create()

    recognizer.read(f'engine\\auth\\trainer\\{path}.yml')  # load trained model
